...
public class FrmEquipoDisponible extends javax.swing.JFrame {
    ...
    // Mostrar ocultar Login: pnlContenedorLogin - es el nombre del panel
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEquipoDisponible.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
